...
module.exports = {
	...
	meterPeakHoldTimePreset_mode: [
		...
		{ id: '01', label: 'Hold Time 1s' },
		{ id: '02', label: 'Hold Time 2s' },
		{ id: '03', label: 'Hold Time 3s' },
		{ id: '04', label: 'Hold Time 4s' },
		{ id: '05', label: 'Hold Time 5s' },
		{ id: '06', label: 'Hold Time 6s' },
		{ id: '07', label: 'Hold Time 7s' },
		{ id: '08', label: 'Hold Time 8s' },
